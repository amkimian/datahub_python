...
class DataSetRelease(object):
    ...
    """
    def __init__(self, id=None, dataset=None, owner=None, state=None, description=None):
        """
    ...
    def state(self):
        """
        Gets the state of this DataSetRelease.
        Is this release published (and therefore immutable)

        :return: The state of this DataSetRelease.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """
        Sets the state of this DataSetRelease.
        Is this release published (and therefore immutable)

        :param state: The state of this DataSetRelease.
        :type: str
        """
