...
class DataElement(object):
    ...
    """
    def __init__(self, id=None, dataset=None, owner=None, release=None, mime_type=None, description=None, type=None, schema=None, state=None, storage=None, content=None, block_id=None, key_field=None, published=None, display_info=None, csv_info=None):
        """
