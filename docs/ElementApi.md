...
body = swagger_client.DataElement() # DataElement | Element object that defines the element in a data set
...
release = 'release_example' # str | The id of the release
element = 'element_example' # str | The id of the element
body = swagger_client.DataElement() # DataElement | The updated element
api_key = 'api_key_example' # str | The user api key (optional)
